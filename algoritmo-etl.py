...
try:
   ...
   # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # OPERACIONES - VALORIZACIÓN DEL CAMPO id_region (Requerimiento de la Tarea)
    # -------------------------------------------------------------------------
    print("OPERACIONES - Actualizando id_region...")
    comando_sql = '''
        UPDATE operaciones 
    ...
    '''
    cursor.execute(comando_sql)
    print("Campo id_region en la tabla operaciones actualizado exitosamente.")
    # -------------------------------------------------------------------------        
